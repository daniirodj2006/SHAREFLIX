...
{
    try {
        $consulta = "CALL ContarTotalPeliculas()";
...
{
    try {
        $consulta = "CALL ContarPeliculasNuevasMes()";
        $resultado = EjecutarConsulta($consulta);
        $fila = mysqli_fetch_assoc($resultado);
        return $fila['total'];
    } catch (Exception $e) {
...
{
    try {
        $consulta = "CALL ContarTotalGeneros()";
        $resultado = EjecutarConsulta($consulta);
        $fila = mysqli_fetch_assoc($resultado);
        return $fila['total'];
    } catch (Exception $e) {
...
{
    try {
        $consulta = "CALL ContarTotalCategorias()";
        $resultado = EjecutarConsulta($consulta);
        $fila = mysqli_fetch_assoc($resultado);
        return $fila['total'];
    } catch (Exception $e) {
...
{
    try {
        $consulta = "CALL ObtenerPeliculasPopulares($limite)";
        $resultado = EjecutarConsulta($consulta);
        $peliculas = array();
