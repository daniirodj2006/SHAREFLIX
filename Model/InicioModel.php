...
function CrearTokenRecuperacion($idUsuario)
{
    try {
        ...
        $consulta = "CALL CrearTokenRecuperacion($idUsuario, '$token', '$fechaExpiracion')";
...
function ValidarTokenRecuperacion($token)
{
    try {
        ...
        $consulta = "CALL ValidarTokenRecuperacion('$token')";
...
{
    try {
        $consulta = "CALL MarcarTokenUsado($idRecuperacion)";
...
function CambiarContrasenna($idUsuario, $contrasenaActual, $nuevaContrasenna)
{
    try {
        ...
        $consulta = "CALL ValidarContrasennaActual($idUsuario, '$contrasenaActual')";
